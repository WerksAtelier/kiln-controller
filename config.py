...
# to produce the actual cost during a run. My kiln has one
# element that when my switches are set to high, consume 1000 watts.

kwh_rate        = 0.35  # cost per kilowatt hour per currency_type to calculate cost to run job
kw_elements     = 1.000 # if the kiln elements are on, the wattage in kilowatts
...
# uncomment this if using MAX-31856
thermocouple_type = MAX31856.MAX31856_F_TYPE
